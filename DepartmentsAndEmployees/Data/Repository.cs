    ...
    public class Repository
    {
        ...
        public SqlConnection Connection
        {
            get
            {
                ...
                string _connectionString = "Server=DESKTOP-T1CK9M7\\SQLEXPRESS;Database=DepartmentsAndEmployees;Trusted_Connection=True;";
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    while (reader.Read())
                    {
                        Employee employee = new Employee
                        {
                            ...
                            FirstName = reader.GetString(reader.GetOrdinal("FirstName")),
                            LastName = reader.GetString(reader.GetOrdinal("LastName")),
                            //DepartmentId throws an error (index out of range)
        ...
        public void UpdateEmployee(int id, Employee employee)
        {
            ...
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    cmd.Parameters.Add(new SqlParameter("@id", id));
                    cmd.Parameters.Add(new SqlParameter("@departmentId", employee.Department.Id));
